...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card">
                <div class="card-header @if (Auth::user()->admin) bg-warning @else bg-primary @endif text-white"><strong>User Dashboard</strong><br>
                    @if (Auth::user()->admin)
                        You are masquerading as:{{$user->name}}
                    @else
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group text-center">
                                <label for="exampleFormControlFile1">
                                    <img src="/uploads/avatars/{{$user->avatar}}" id="wapp-img" class="img-fluid rounded-circle" />
                                </label>                            
                            </div>
                                <input name="avatar" type="file" value="{{$user->avatar}}" class="invisible" id="avatar">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-4">
                            @if (Auth::user()->admin)
                                <a class="btn btn-success" href="{{ route('admin') }}">Ruturn to Admin Area</a>
                            @endif
                        </div>
                    </div>                       
                    </form>                     
